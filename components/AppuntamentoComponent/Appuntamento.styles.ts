...
export const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, textAlign: 'center', fontWeight: '800', color: '#EB5F19', top: -30, width: wp('90%')},
  subTitle: { fontSize: 24, textAlign: 'center', fontWeight: '800', color: '#4975be', top: -20 },
  ...
  textRiepilogoPrenotazione: { flexDirection: 'column', fontSize: 25, color: '#4975be', fontWeight: "800", alignSelf: 'center', marginBottom: 20 },
  textRiepilogoNumeroPrenotazione: { flexDirection: 'column', fontSize: 100,  color: '#EB5F19',   alignSelf: 'center' },
  codicePrenotazione: { flexDirection: 'column', fontSize: 25, color: '#4975be',  alignSelf: 'center' },
